...
class ScraperCoupang(Scraper):
    ...
    def validateCandidate(self, product_preview: ProductPreview):
        if product_preview.original_price < 50000:
            return False
    ...
    def collectCandidate(self):
        ...
        for currentPage in range(1, 30):
            if not self.is_last_page:
                ...
                url = f'https://www.coupang.com/np/categories/497141?listSize=120&brand=3134%2C259%2C258%2C58612%2C17436%2C17000%2C257%2C49480%2C263%2C17031&offerCondition=&filterType=rocket%2Crocket_wow%2Ccoupang_global&isPriceRange=false&minPrice=&maxPrice=&page={currentPage}&channel=user&fromComponent=N&selectedPlpKeepFilter=&sorter=bestAsc&filter=&component=497041&rating=0&rocketAll=true'
...
scraperCoupang = ScraperCoupang(productTypeId=2)
